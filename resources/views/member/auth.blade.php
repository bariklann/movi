            ...
            <div class="pt-[30px] relative">
                ...
                <div class="pt-[85px] flex flex-col items-center gap-5 px-3">
                    ...
                    <section class="w-11/12 max-w-[460px">
                        <form action="{{ route('member.login.auth') }}" method="POST" enctype="multipart/form-data" class="mt-[70px] flex flex-col bg-white p-[30px] rounded-2xl gap-6">
                            @csrf                          
                            @error('credentials')
